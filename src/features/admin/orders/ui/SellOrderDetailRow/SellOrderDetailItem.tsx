...
import { rarityColors, getItemRarity, getItemExterior } from "@/features/admin/shared/utils";
import { Order } from "@/features/admin/domain/types";

interface SellOrderDetailItemProps {
...
export function SellOrderDetailItem({
  item,
  resolvedDetails,
  sellerSteamId,
}: SellOrderDetailItemProps) {
  const { t } = useI18n();
      ...
      <div className="flex-1 min-w-0 space-y-2">
        ...
        <div className="flex flex-wrap items-center gap-2 text-[9px] font-mono text-[#84849b]">
          <a
            href={
              sellerSteamId
                ? `https://steamcommunity.com/profiles/${sellerSteamId}/inventory/#730`
