...
function RaffleListCard({ raffle, href }: { raffle: RaffleSummary; href: string }) {
  ...
  return (
    <Link
      href={href}
      className="block w-full text-left rounded-[3px] border border-white/5 bg-[#110f1e]/35 p-4 transition-all hover:border-accent/30 hover:bg-accent/5"
    >
