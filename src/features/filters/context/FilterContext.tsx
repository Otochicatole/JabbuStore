...
const CATEGORY_TOKEN_TO_LABEL: Record<string, string> = {
  knives: "Cuchillos",
  gloves: "Guantes",
  pistols: "Pistolas",
  smgs: "Subfusiles",
  rifles: "Rifles de asalto",
  snipers: "Rifles de francotirador",
  shotguns: "Escopetas",
  machine_guns: "Ametralladoras",
  equipment: "Equipo / Zeus",
  agents: "Agentes",
  containers: "Cajas y contenedores",
  stickers: "Stickers",
  charms: "Llaveros / Charms",
  graffiti: "Grafitis",
  patches: "Parches",
  music_kits: "Kits musicales",
