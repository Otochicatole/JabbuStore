...
const BASE_CATEGORIES: CatalogCategory[] = [
  { value: "Cuchillos", token: "knives", labelKey: "filters.category.knives", icon: "knives.webp" },
  { value: "Guantes", token: "gloves", labelKey: "filters.category.gloves", icon: "gloves.webp" },
  { value: "Pistolas", token: "pistols", labelKey: "filters.category.pistols", icon: "pistols.webp" },
  { value: "Subfusiles", token: "smgs", labelKey: "filters.category.smgs", icon: "smgs.webp" },
  { value: "Rifles de asalto", token: "rifles", labelKey: "filters.category.assaultRifles", icon: "asault-rifles.webp" },
  { value: "Rifles de francotirador", token: "snipers", labelKey: "filters.category.sniperRifles", icon: "snipers.webp" },
  { value: "Escopetas", token: "shotguns", labelKey: "filters.category.shotguns", icon: "shotguns.webp" },
  { value: "Ametralladoras", token: "machine_guns", labelKey: "filters.category.machineGuns", icon: "machine-guns.webp" },
];

const GLOBAL_CATEGORIES: CatalogCategory[] = [
  ...BASE_CATEGORIES,
  { value: "Equipo / Zeus", token: "equipment", labelKey: "filters.category.equipment", icon: null },
  { value: "Stickers", token: "stickers", labelKey: "filters.category.stickers", icon: "stickers.webp" },
  { value: "Cajas y contenedores", token: "containers", labelKey: "filters.category.containers", icon: null },
  { value: "Agentes", token: "agents", labelKey: "filters.category.agents", icon: "agents.webp" },
  { value: "Llaveros / Charms", token: "charms", labelKey: "filters.category.charms", icon: null },
  { value: "Grafitis", token: "graffiti", labelKey: "filters.category.graffiti", icon: null },
  { value: "Parches", token: "patches", labelKey: "filters.category.patches", icon: null },
  { value: "Kits musicales", token: "music_kits", labelKey: "filters.category.musicKits", icon: null },
  { value: "Coleccionables", token: "collectibles", labelKey: "filters.category.collectibles", icon: null },
  { value: "Pases", token: "passes", labelKey: "filters.category.passes", icon: null },
  { value: "Llaves", token: "keys", labelKey: "filters.category.keys", icon: null },
  { value: "Regalos", token: "gifts", labelKey: "filters.category.gifts", icon: null },
  { value: "Herramientas", token: "tools", labelKey: "filters.category.tools", icon: null },
  { value: "Etiquetas", token: "tags", labelKey: "filters.category.tags", icon: null },
];
