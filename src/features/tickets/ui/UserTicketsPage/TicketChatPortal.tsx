...
export function TicketChatPortal({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[120] flex h-dvh flex-col bg-[#070510]">
      <div className="flex shrink-0 items-center justify-between gap-4 border-b border-white/10 bg-[#0f0d1e] px-4 py-4 sm:px-6">
        <div className="min-w-0">
          <p className="truncate text-[11px] font-mono text-white/40">
